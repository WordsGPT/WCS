...
def validate_contexts_with_gemini_detailed(
    ...
    *,
    ...
    prompt = (
        ...
        "Accept authentic historical spelling and formatting. Do not reject older texts "
        ...
        "turns, or colloquial speech) is valid and should be accepted. However, continue "
        "to strictly reject actual OCR spelling corruption, scanning typos, or spacing "
        "errors (such as 'H e', 'yenido', or 'uoa mujer') that make the context "
