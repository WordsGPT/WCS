...
class FrequencyWcsToolTests(unittest.TestCase):
    ...
    def test_summarize_words_and_correlations(self):
        metadata = {
            "common": {"rank": 10, "count": 1000, "sample_contexts": 1, "frequency_band": "1-1000"},
            "rare": {"rank": 20000, "count": 20, "sample_contexts": 1, "frequency_band": "10001-100000"},
        }
        groups = {
            ("fixture", 1.0, "common", "sample-1"): [
                {"word_token_index": 0, "rank": 1, "cumulative_probability": 0.5, "probability_ratio_to_top": 1.0}
            ],
            ("fixture", 1.0, "rare", "sample-2"): [
                {"word_token_index": 0, "rank": 100, "cumulative_probability": 0.99, "probability_ratio_to_top": 0.001}
            ],
        }
